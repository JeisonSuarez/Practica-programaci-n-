...
public class FrmTreeDemo extends javax.swing.JFrame {
     ...
     */
    public FrmTreeDemo() throws IOException {
        initComponents();
    ...
    private void initComponents() {
        ...
        treeAccount.setToolTipText("");
        treeAccount.setName(""); // NOI18N
        jScrollPane1.setViewportView(treeAccount);
        treeAccount.getAccessibleContext().setAccessibleName("");

        jPanel2.add(jScrollPane1, java.awt.BorderLayout.CENTER);

        pnlContent.setPreferredSize(new java.awt.Dimension(150, 150));
        jPanel2.add(pnlContent, java.awt.BorderLayout.LINE_END);
        pnlContent.getAccessibleContext().setAccessibleDescription("");

        getContentPane().add(jPanel2, java.awt.BorderLayout.CENTER);

        setSize(new java.awt.Dimension(376, 313));
